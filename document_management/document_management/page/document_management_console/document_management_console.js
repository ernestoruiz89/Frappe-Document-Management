        ...
        const app = createApp({
            setup() {
                ...
                const fetch_documents = () => {
                    loading.value = true;
                    frappe.call({
                        method: 'document_management.document_management.page.document_management_console.document_management_console.get_documents',
                        args: {
                ...
                const fetch_categories = () => {
                    frappe.call({
                        method: 'document_management.document_management.page.document_management_console.document_management_console.get_categories',
                        callback: (r) => {
                ...
                const fetch_saved_views = () => {
                    frappe.call({
                        method: 'document_management.document_management.page.document_management_console.document_management_console.list_saved_views',
                        callback: (r) => {
                ...
                const save_view = () => {
                    frappe.prompt(
                        ...
                        (values) => {
                            frappe.call({
                                method: 'document_management.document_management.page.document_management_console.document_management_console.save_current_view',
                                args: {
                ...
                const delete_view = () => {
                    ...
                    frappe.confirm(__('Delete this saved view?'), () => {
                        frappe.call({
                            method: 'document_management.document_management.page.document_management_console.document_management_console.delete_saved_view',
                            args: {view: name},
                            callback: (r) => {
                                if (!r.exc) {
                ...
                const run_bulk_action = (method, args, message) => {
                    return new Promise((resolve, reject) => {
                        frappe.call({
                            method: `document_management.document_management.page.document_management_console.document_management_console.${method}`,
                            args,
                            freeze: true,
                            callback: (r) => {
                                if (!r.exc) {
                ...
                const force_pdf = (doc_name) => {
                    frappe.call({
                        method: 'document_management.document_management.page.document_management_console.document_management_console.force_generate_pdf',
                ...
                const reprocess_ocr = (doc_name) => {
                    frappe.confirm(
                        ...
                        () => {
                            frappe.call({
                                method: 'document_management.document_management.page.document_management_console.document_management_console.reprocess_ocr',
                                args: {doc_name},
                                callback: (r) => {
                                    if (!r.exc) {
                ...
                const fetch_folders = () => {
                    frappe.call({
                        method: 'document_management.document_management.page.document_management_console.document_management_console.get_folders',
                        callback: (r) => {
                ...
                const fetch_tags = () => {
                    frappe.call({
                        method: 'document_management.document_management.page.document_management_console.document_management_console.get_tags',
                        callback: (r) => {
