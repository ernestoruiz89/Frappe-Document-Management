...
def _apply_tags(doc, extracted_text):
    ...
    changed = False
    try:
        from document_management.frappe_document_management.utils.auto_tagger import apply_auto_tags
    ...
    try:
        from document_management.frappe_document_management.utils.ml_tagger import predict_tags
